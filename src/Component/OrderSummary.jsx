    ...
    <div className="bg-white p-8 rounded-xl soft-glow border border-surface-container">
      ...
      <div className="space-y-4 mb-6">
        ...
        <div className="flex justify-between text-on-surface-variant">
          ...
          <span className="font-body-md">{shipping === 0 ? "Free" : `$${shipping.toFixed(2)}`}</span>
        </div>
        <div className="flex justify-between text-on-surface-variant">
      ...
      <div className="pt-6 border-t border-outline-variant/20 mb-8 flex justify-between items-end">
        ...
        <span className="font-display-lg text-display-lg-mobile text-primary">${total.toFixed(2)}</span>
      </div>
      {showCheckoutButton && (
        <>
          <Link
