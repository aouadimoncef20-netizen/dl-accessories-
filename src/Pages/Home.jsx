...
const newArrivals = [
  {
    ...
    category: "Bracelets",
    price: 124.0,
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDcoN1E16_0R4d6fxTy182GbRp08ffx3ApWl9P0oQeEqGoLLLh6gLuHWJA9S1kJZtoQgQ2vyyELctoOK5JuUOa5dQLgGhpoISl-sl-Hr6jPSjtG4DLKsGkINLxrp-gQSKt6o-F4lFmBf2L26C37_mhQfctkjJ-1kvwMsvAzx4GiGMY0FjnOkOW4Js87gUQbz3IpKMNV116EImmZQLJFXW_6kMCCfzOhhLe8RZZfGiu5nD9VtLAcsRpS",
  },
  { id: "aura-mesh-silver", name: "Aura Mesh Silver", category: "Watches", price: 189.0, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBoNDdVoa8kAhrvrOOx2202zWfqJksi8lPzgN9q9mD088p1fzqZpd3EIE15nD7fbNmabZYb9JPVIS5cxia7qUo-Vqxw1Hr6LWGVxT29hRL3mDUvMWAf2cN2A4m1S-GXP1SrQ6oXdDAVY2gK3RchjpZT5BAZIwcOTCzZ0SKAkL8hnVKZcqUMHUtb3FIlbB5joGoyrjUR2NPAg8Y4m-aWv4G2GXq9Y3zUjXoY7MvIjt_YmidQsbjLx-RZ" },
  { id: "lumina-pearl-hoops", name: "Lumina Pearl Hoops", category: "Earrings", price: 86.0, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCLWTlVJfwLwYBeuD8aePBV4mZqtaquVw2RRI_ZaVdcB3gOB4KCifn11cOpUNsnPBf4GYlnHBwb7Pu2TPAFekaXzs6I0DY3PVTs1dwBdwlk7NTS8ZlH_dJrYERXjaUqj3LYnp9kRJ77Z8xthhONzblH_diVhaTosCDl3dUl5Ih_OdSO6SFL384rh5JKfa_yw1FVjcg4bTdF7N6SloP9lDZXXh77zB2YUAHmHCnhECVWOzWAqexgZbP4" },
  { id: "solstice-link-chain", name: "Solstice Link Chain", category: "Necklaces", price: 110.0, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCEjVh7XLwRYh9rngEvE28zCo3AW9oYcjNgGhhC9L8-rIgxaa1pRhPYLr_zg7sJhjTMshUpCXqUTeDAprL7OwexjyhhugER5vx-nrroNRR4UMdpLY-jNGfmy4a2TmonwpNE61EmxqrSkWd3Lcq0KJ4YK81QY5XveYAknofcxoMN88v1e-nVoXf5UkHEl3kh8CLf0Ib1u6uCDd4YmaEYFgJmMsN65e_cjd4TwYZ1dupGOn-vhx3_UhK1" },
];

const bestSellers = [
  { id: "aura-gold-classic", name: "Aura Gold Classic", price: 195.0, image1: images.bestSellers[0]?.front || "", image2: images.bestSellers[0]?.back || "" },
  { id: "timeless-layer-set", name: "Timeless Layer Set", price: 240.0, image1: images.bestSellers[1]?.front || "", image2: images.bestSellers[1]?.back || "" },
  { id: "cascading-silver-drops", name: "Cascading Silver Drops", price: 155.0, image1: images.bestSellers[2]?.front || "", image2: images.bestSellers[2]?.back || "" },
];

const testimonials = [
  { quote: "The quality of the Aura watch exceeded all my expectations. It feels heavy, premium, and works with every outfit.", name: "Elena Roberts", image: images.reviews[0] },
...
const Home = () => {
  ...
  return (
    ...
    <div className="Home">
      ...
      {/* ================================================================
          SECTION 1: HERO — Editorial Fullscreen
          ================================================================ */}
        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="max-w-2xl px-margin-mobile md:px-margin-desktop pt-20">
            ...
            <h1 className="font-display-lg text-[44px] md:text-display-lg text-white mb-6 leading-tight drop-shadow-lg">
              Details Make You{" "}
              <span className="italic font-light">Shine</span>
            </h1>
            <p className="font-body-lg text-body-lg text-white/90 mb-10 max-w-lg drop-shadow-md leading-relaxed">
              Curated accessories for the modern muse — where every detail
              speaks of timeless elegance and quiet confidence.
            </p>
            <Link
              to="/collections"
              className="inline-flex items-center gap-3 bg-white text-primary px-8 md:px-10 py-4 rounded-full font-label-md uppercase tracking-widest hover:bg-primary hover:text-white transition-all duration-500 shadow-xl shadow-black/10"
            >
              Discover Collection
      ...
      {/* <section className="bg-surface-container-low py-section-gap overflow-hidden">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="flex justify-between items-center mb-12">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex gap-2">
                <button onClick={() => handleScroll("left")} className="w-10 h-10 rounded-full border border-outline/20 flex items-center justify-center text-on-surface-variant hover:bg-white hover:border-primary/30 hover:text-primary transition-all duration-300" aria-label="Scroll left">
                  <span className="material-symbols-outlined text-lg">chevron_left</span>
                </button>
                <button onClick={() => handleScroll("right")} className="w-10 h-10 rounded-full border border-outline/20 flex items-center justify-center text-on-surface-variant hover:bg-white hover:border-primary/30 hover:text-primary transition-all duration-300" aria-label="Scroll right">
          ...
          <div ref={scrollRef} className="flex gap-4 overflow-x-auto hide-scrollbar scroll-smooth pb-2 -mx-4 px-4">
            {newArrivals.map((item) => (
              <div key={item.id} className="min-w-[200px] md:min-w-[220px] flex-shrink-0">
                <div className="bg-white p-3 rounded-xl ambient-glow group">
                  <div className="aspect-[4/5] rounded-lg overflow-hidden mb-3 relative">
                    <Link to={`/product/${item.id}`}>
                      <img src={item.image} alt={item.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                    </Link>
                    <span className="absolute top-2 left-2 bg-primary/90 text-white text-[10px] font-label-sm uppercase tracking-widest px-2 py-0.5 rounded-full">New</span>
                  </div>
                  <h3 className="font-headline-sm text-sm text-on-surface mb-0.5 leading-tight">{item.name}</h3>
                  <p className="font-label-sm text-[10px] text-secondary uppercase tracking-widest mb-1.5">{item.category}</p>
                  <p className="font-label-md text-primary font-semibold">${item.price.toFixed(2)}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="flex justify-center mt-8 md:hidden">
            <Link to="/collections" className="inline-flex items-center gap-1.5 font-label-sm text-primary uppercase tracking-widest border-b border-primary/30 pb-0.5 hover:border-primary transition-all">
      ...
      {/* ================================================================
          SECTION 4: BEST SELLERS — Editorial Grid
          ================================================================ */}
            ...
            {bestSellers.map((item, idx) => {
              ...
              return (
                <Link
                  key={item.id}
                  to={`/product/${item.id}`}
                  className={`group cursor-pointer block ${isOffset ? "md:mt-10" : ""} ${idx === 2 ? "md:mt-0" : ""}`}
                  onMouseEnter={() => setHoveredSeller(item.id)}
                ...
                >
                  <div className="relative aspect-[3/4] bg-surface-container-low rounded-2xl overflow-hidden mb-5 shadow-sm">
                    <img src={item.image1} alt={item.name}
                      className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ${hoveredSeller === item.id ? "opacity-0" : "opacity-100"}`} />
                    <img src={item.image2} alt={`${item.name} alternate`}
                      className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ${hoveredSeller === item.id ? "opacity-100" : "opacity-0"}`} />

                    <span className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm text-on-surface text-[10px] font-label-sm uppercase tracking-widest px-3 py-1.5 rounded-full shadow-sm">
                      Best Seller
                    </span>

                    <div className={`absolute bottom-5 inset-x-0 flex justify-center transition-all duration-300 ${hoveredSeller === item.id ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
                      <span className="px-6 py-2.5 bg-white/90 backdrop-blur-md text-on-surface rounded-full font-label-md text-xs uppercase tracking-widest hover:bg-primary hover:text-white transition-colors shadow-lg">
                        Quick View
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="font-label-md text-on-surface-variant">${item.price.toFixed(2)}</p>
                  </div>
                </Link>
              );
            })}
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="flex items-center justify-between mb-12">
            ...
            <a href="https://www.instagram.com/dl.accessoires.reghaia/" target="_blank" rel="noopener noreferrer"
              className="hidden md:inline-flex items-center gap-2 font-label-sm text-primary uppercase tracking-widest border-b border-primary/30 pb-0.5 hover:border-primary transition-all">
              Follow Us
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 md:gap-3">
            {instagramImages.map((src, idx) => (
              <a key={idx} href="https://www.instagram.com/dl.accessoires.reghaia/" target="_blank" rel="noopener noreferrer"
                className="relative group overflow-hidden rounded-xl aspect-square bg-surface-container-low">
          ...
          <div className="flex justify-center mt-8 md:hidden">
            <a href="https://www.instagram.com/dl.accessoires.reghaia/" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 font-label-sm text-primary uppercase tracking-widest border-b border-primary/30 pb-0.5 hover:border-primary transition-all">
              Follow Us @DL.ACCESSORIES
              <span className="material-symbols-outlined text-base">open_in_new</span>
            </a>
          </div>
        </div>
